...
// مكتبة لفتح تطبيقات خارجية مثل Google Maps
import 'package:url_launcher/url_launcher.dart';

class ElshrokScreen extends StatelessWidget {
  const ElshrokScreen({super.key});

  // ==============================
  // دالة فتح Google Maps
  // ==============================
  Future<void> openMap() async {
    // 1) التأكد من إذن الوصول للموقع
    LocationPermission permission = await Geolocator.checkPermission();

    // إذا لم يكن الإذن مفعّل نطلبه من المستخدم
                      ...
                      children: const [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              "0.8 km away from your location",
                              style: TextStyle(color: Color(0xFF00D492)),
                            ),
                          ],
                        ),
