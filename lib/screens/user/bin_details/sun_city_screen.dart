...
class SunCityScreen extends StatelessWidget {
  const SunCityScreen({super.key});
  ...
  Future<void> openMap() async {
    ...
    final Uri googleUrl = Uri.parse(
      "https://www.google.com/maps/search/?api=1&query=sun city mall",
    );
                      ...
                      children: const [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              "El-Nasr Rd, Sheraton Al Matar",
                              style: TextStyle(color: Colors.white),
                            ),

                            Text(
                              "2.5 km away from your location",
                              style: TextStyle(color: Color(0xFF00D492)),
                            ),
                          ],
                        ),
